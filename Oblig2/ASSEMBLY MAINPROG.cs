    ...
    public static List<SpaceObject> solarSystem = new List<SpaceObject>
        {
            ...
            new Planet("Jupiter", 2,12,69911,10,"Orange"),
            new Planet("Saturn", 3,10759,58232,0.45,"Gold"),
            new Planet("Uranus", 3.5,84,25362,0.74,"green"),
            new Planet("Neptune", 4,60190,24622,0.67,"DarkBlue"),
            ...
            new Moon("Io", 0.00282, 1.769, 3643, 1.769, "Sulfur yellow", "Jupiter"),
            new Moon("Europa", 0.00449, 3.551, 3122, 3.551, "Whitish", "Jupiter"),
            new Moon("Ganymede", 0.00716, 7.155, 5262, 7.155, "Gray", "Jupiter"),
            new Moon("Callisto", 0.01258, 16.689, 4820, 16.689, "Brown-gray", "Jupiter"),
            new Moon("Mimas", 0.0000196, 0.942, 198, 0.942, "Gray", "Saturn"),
            new Moon("Enceladus", 0.000031, 1.37, 252, 1.37, "White", "Saturn"),
            new Moon("Tethys", 0.000051, 1.888, 1062, 1.888, "Gray", "Saturn"),
            new Moon ("Dione", 0.000084, 2.736, 1123, 2.736, "White", "Saturn"),
            new Moon("Rhea", 0.000228, 4.518, 1529, 4.518, "White", "Saturn"),
            new Moon("Titan", 0.00817, 15.95, 5149, 15.95, "Orange-brown", "Saturn"),
            new Moon("Iapetus", 0.00287, 79.3215, 1436, 79.3215, "Two-tone", "Saturn"),
            new Moon("Miranda", 0.00000142, 1.413, 235, 1.413, "Gray", "Uranus"),
            new Moon("Ariel", 0.0000131, 2.52, 1158, 2.52, "Pale orange", "Uranus"),
            new Moon("Umbriel", 0.0000164, 4.144, 1170, 4.144, "Dark gray", "Uranus"),
            ...
            new Moon("Nereid", 0.0364, 360.136, 170, 360.136, "Dark gray", "Neptune"),
